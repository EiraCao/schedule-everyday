...
> "忙了一天，但好像什么都没做完？""总觉得有件事忘了，但想不起来是什么？""怎么永远也找不到时间做重要但不紧急的事情？"

这是一个「数字秘书」skill，核心目标是**减少认知负担**。安装后你的 OpenClaw 就学会了怎么做一个“秘书”，它会这样做：
- **① 长期维护一个飞书内的事项清单文档**，你的任何事项或灵感都可以随时丢给它；
...
- **事项管理** — 添加/更新/归档事项。**你可以尽情“把球打出去”，保护自己的脑力**。任何突然的ddl、班群的提醒、主任的要求，或者自己的灵感，随时丢给 OpenClaw，就会自动记录归类到事情清单文档，并且在每日和每周对齐时再和你一起计划。
...
| **MoSCoW + Exploration** | 对长待办清单有压力 | 增加「无承诺」维度：保护灵感，不给压力 |
也可以自由选择任务的优先级划分方式。
